...
api/votings/list/ - Create new VOTING. POST request. - JSON Example: {"title": "VotingTestTitle", "type": {0 - Cane vote only only for one choice / 1 - Can vote for every choice}}
